...
-- shéma rationnel
/*
adherent(pk matricule, nom, prenom, adresse, dateNaissance)
activite(pk idActivite, nomActivite, type, description, cout_organisation, prix_vente_client)
seance(pk idSeance, dateSeance, heure, nbr_place_disponible, fk idActivite)
appreciation(pk idApprecitation, note_appreciation, fk matricule, fk idSeance)
