...
namespace prog_final
{
        ...
        global::Microsoft.UI.Xaml.Markup.IComponentConnector
    {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.UI.Xaml.Markup.Compiler"," 3.0.0.2408")]
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        private class pageAjouterSeance_obj7_Bindings :
            ...
            IpageAjouterSeance_Bindings
        {
            ...
            public pageAjouterSeance_obj7_Bindings()
            {
            }

            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 193 && columnNumber == 53)
                {
                    isobj8TextDisabled = true;
                }
                else if (lineNumber == 187 && columnNumber == 53)
                {
                    isobj9TextDisabled = true;
                }
                else if (lineNumber == 181 && columnNumber == 53)
                {
                    isobj10TextDisabled = true;
                }
                else if (lineNumber == 175 && columnNumber == 53)
                {
                    isobj11TextDisabled = true;
                }
                else if (lineNumber == 169 && columnNumber == 53)
                {
                    isobj12TextDisabled = true;
                }
                else if (lineNumber == 162 && columnNumber == 44)
                {
            ...
            public void Connect(int connectionId, global::System.Object target)
            {
                switch(connectionId)
                {
                    case 7: // pageAjouterSeance.xaml line 146
            ...
            private void Update_Moyenne_appreciation(global::System.Double obj, int phase)
            {
                ...
                {
                    // pageAjouterSeance.xaml line 193
            ...
            private void Update_Nbr_place_disponible(global::System.Int32 obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // pageAjouterSeance.xaml line 187
            ...
            private void Update_Nbr_inscription(global::System.Int32 obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // pageAjouterSeance.xaml line 181
            ...
            private void Update_Heure(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // pageAjouterSeance.xaml line 175
            ...
            private void Update_Date_seance_string(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // pageAjouterSeance.xaml line 169
            ...
            private void Update_NomActivite(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // pageAjouterSeance.xaml line 162
        ...
        public void Connect(int connectionId, object target)
        {
            ...
            case 4: // pageAjouterSeance.xaml line 132
                ...
                break;
            case 5: // pageAjouterSeance.xaml line 143
                {
        ...
        public global::Microsoft.UI.Xaml.Markup.IComponentConnector GetBindingConnector(int connectionId, object target)
        {
            ...
            case 7: // pageAjouterSeance.xaml line 146
                {                    
                    ...
                    pageAjouterSeance_obj7_Bindings bindings = new pageAjouterSeance_obj7_Bindings();
