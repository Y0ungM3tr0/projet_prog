#pragma checksum "D:\session_3_disc\prog_graph\prog_final_69\prog_final\pageStatistique3.xaml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "3AB0D5C14F91C75A3DA195A6A98B170276C0EBFADA9ECA700A24F407BCF82032"
//------------------------------------------------------------------------------
// <auto-generated>
            ...
            IpageStatistique3_Bindings
        {
            ...
            private void Update_(global::prog_final.Activite obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_Nbr_seance(obj.Nbr_seance, phase);
                        this.Update_Nom_activite(obj.Nom_activite, phase);
                    }
                }
            }
            private void Update_Nbr_seance(global::System.Int32 obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
