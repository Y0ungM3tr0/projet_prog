...
-- projet final de base de données et de programmation graphique
...
-- Empêcher l'ajout de notes d'un adhérent sur une séance s'il a déja noté cette séance avant son insertion
DELIMITER //
...
-- Créations des procédures stockées
-- administrateur
-- aucune procédures stockées
...
DELIMITER ;
-- Appel à la procédure
-- CALL Ajouter_seance(10, '2024-12-07', '18:00', 10);
...
DELIMITER ;
-- Appel à la procédure
-- CALL infos_reservations_de_utilisateur('JD-1990-532');
...
-- Créations des fonctions stockées
-- administrateur
...
/*  LES MATRICULE NE CORRESPONDENT PROBABLEMENT PAS À CHAQUE CRÉATION D'ADHÉRENT À CAUSE DES TROIS NOMBRE GÉNÉRÉS ALÉATOIREMENT  */
