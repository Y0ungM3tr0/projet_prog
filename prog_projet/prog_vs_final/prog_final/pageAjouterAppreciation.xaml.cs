...
namespace prog_final
{
    public sealed partial class pageAjouterAppreciation : Page
    {
        ...
        {
            int lenght_avant = SingletonAppreciation.getInstance().getListe_des_appreciations().Count;
            ...
            int lenght_apres = SingletonAppreciation.getInstance().getListe_des_appreciations().Count;
            ...
            noterGrid.Visibility = Visibility.Collapsed;
        }
    }
}
