...
namespace prog_final
{
    internal class Activite : INotifyPropertyChanged
    {
        ...
        public Activite(string nom_activite, int nbr_seance_par_activite)
        {
            this.nom_activite = nom_activite;
            this.nbr_seance_par_activite = nbr_seance_par_activite;
        }
        ...
        // nbr_seance_par_activite
        public int Nbr_seance_par_activite
        {
            get => nbr_seance_par_activite;
            set
            {
                nbr_seance_par_activite = value;
                this.OnPropertyChanged(nameof(Nbr_seance_par_activite));
            }
        }
