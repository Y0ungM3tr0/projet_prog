...
namespace prog_final
{
    internal class Seance : INotifyPropertyChanged
    {
        ...
        public Seance(int idSeance, int idActivite, DateTime date_seance, string heure, int nbr_place_disponible, int nbr_inscription, double moyenne_appreciation, string nomActivite, string description, int idReservation, string matricule)
        {
            this.idSeance = idSeance;
            this.idActivite = idActivite;
            this.date_seance = date_seance;
        ...
        public Visibility Afficher {
            get
            {
                if (SingletonUtilisateur.getInstance().Connecter == true && SingletonUtilisateur.getInstance().StatutUtilisateur == false)
