    ...
    internal class SingletonSeance
    {
        ...
        public void getToutSeances()
        {
            ...
            try
            {
                ...
                commande.CommandText = "SELECT * FROM infos_seance;";
        ...
        // suppriemr une seance dans la bd
        public void supprimerSeance(int idSeance)
        {
            try
            {
                MySqlCommand commande = new MySqlCommand();
                commande.Connection = con;
                commande.CommandText = "CALL Supprimer_seance(@idSeance);";
        ...
        // suppriemr une seance dans la bd
        public void modifierSeance(int idSeance, int idActivite, DateTime date_seance, string heure, int nbr_place_disponible)
        {
            try
            {
                MySqlCommand commande = new MySqlCommand();
                commande.Connection = con;
                commande.CommandText = "CALL Modifier_seance(@idSeance, @idActivite, @date_seance, @heure, @nbr_place_disponible);";
        ...
        public void getSeancesUtilisateur()
        {
            ...
            try
            {
                MySqlCommand commande = new MySqlCommand();
                commande.Connection = con;
                commande.CommandText = "CALL infos_seance_reservations_utilisateur_pour_appreciation(@matricule);";
